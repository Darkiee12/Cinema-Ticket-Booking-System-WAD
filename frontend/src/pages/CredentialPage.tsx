  ...
  return (
    <div className="w-full">
      <form className="w-full">
        <p className="text-[25px] font-semibold font-Montserrat md:text-2xl text-center">
          Sign in
        </p>
        <p className="text-[#03C04A] text-sm italic font-medium font-Montserrat text-center pt-2">
          {info}
        </p>
        <div className="md:px-48 sm:px-12 px-10 py-3">
          <input
            className="w-full border-4 px-5 py-2 rounded-[10px] border-[#03C04A] bg-[#FDF7DC] focus:border-green-400 focus:outline-none"
            type="email"
            placeholder="Email"
            value={email}
  ...
  return (
    <div className="w-full">
      <form className="w-full pt-2">
        <p className="text-[25px] font-semibold font-Montserrat md:text-2xl text-center pb-2">
          Register
        </p>
        {info.length > 0 && (
          <p className="text-[#03C04A] text-sm italic font-medium font-Montserrat text-center pt-2">
...
const CredentialPage = () => {
  return (
    <div className="flex flex-col justify-center max-w-[1040px] h-screen mx-auto bg-[#FDF7DC]">
      <Login />
      <p className="text-black text-xl font-medium font-Montserrat text-center pt-2">
